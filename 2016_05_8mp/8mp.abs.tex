\section{Brief description of the project (first draft)}
...
we expect that structural transformation occurs through the development of new sectors that are close in the network to the existing sectors in the city.
Moreover, we anticipate that this diffusive process is a predictor of economic growth~\cite{hidalgo2009}.
